...
def main():
  ...
  if args.model in ['figaro-melody', 'figaro-melody-no-inst', 'figaro-melody-no-chord', 'figaro-melody-no-meta', 'vq-vae-accomp']:
  ...
  if args.model in ['figaro-no-inst', 'figaro-no-chord', 'figaro-no-meta', 'figaro-melody', 'figaro-melody-no-inst', 'figaro-melody-no-chord', 'figaro-melody-no-meta', 'vq-vae-accomp']:
